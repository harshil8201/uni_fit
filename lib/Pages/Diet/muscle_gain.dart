...
class MuscleGainDiet extends StatefulWidget {
  const MuscleGainDiet({Key key}) : super(key: key);

  @override
  _MuscleGainDietState createState() => _MuscleGainDietState();
}

class _MuscleGainDietState extends State<MuscleGainDiet> {
  @override
