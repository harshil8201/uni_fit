...
class BeginnerChestStart extends StatefulWidget {
  const BeginnerChestStart({Key key}) : super(key: key);

  @override
  _BeginnerChestStartState createState() => _BeginnerChestStartState();
}

class _BeginnerChestStartState extends State<BeginnerChestStart> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/beginner/chestB.jpg'),
          fit: BoxFit.cover,
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'chestCal': FieldValue.increment(106)});
