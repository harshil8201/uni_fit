...
class NormalDiet extends StatefulWidget {
  const NormalDiet({Key key}) : super(key: key);

  @override
  _NormalDietState createState() => _NormalDietState();
}

class _NormalDietState extends State<NormalDiet> {
  @override
