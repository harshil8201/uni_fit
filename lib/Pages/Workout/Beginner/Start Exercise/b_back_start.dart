...
class BeginnerBackStart extends StatefulWidget {
  const BeginnerBackStart({Key key}) : super(key: key);

  @override
  _BeginnerBackStartState createState() => _BeginnerBackStartState();
}

class _BeginnerBackStartState extends State<BeginnerBackStart> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/beginner/backB.jpg'),
          fit: BoxFit.cover,
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'backCal': FieldValue.increment(102)});
