...
class IntermediateChestStart extends StatefulWidget {
  const IntermediateChestStart({Key key}) : super(key: key);

  @override
  _IntermediateChestStartState createState() => _IntermediateChestStartState();
}
        ...
        child: Stack(
          children: [
            ...
            if (second < 1) ...[
              ...
              erContainer('incline push ups', 'sets: X20'),
              realButton(),
              ...
              erContainer('chest stretch', '25 sec'),
              realButton(),
            ] else
              endWorkout(),
          ],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/intermediate/chestI.jpg'),
          fit: BoxFit.cover,
