...
class AdvanceBackStart extends StatefulWidget {
  const AdvanceBackStart({Key key}) : super(key: key);

  @override
  _AdvanceBackStartState createState() => _AdvanceBackStartState();
}

class _AdvanceBackStartState extends State<AdvanceBackStart> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/advance/backA.jpg'),
          fit: BoxFit.cover,
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'backCal': FieldValue.increment(145)});
