...
class IntermediateAbsStart extends StatefulWidget {
  const IntermediateAbsStart({Key key}) : super(key: key);

  @override
  _IntermediateAbsStartState createState() => _IntermediateAbsStartState();
}

class _IntermediateAbsStartState extends State<IntermediateAbsStart> {
        ...
        child: Stack(
          children: [
            ...
            if (second < 1) ...[
              ...
              erContainer('abdominals crunch', 'sets : X20'),
              realButton(),
              ...
              erContainer('cobra stretch', '25 sec'),
              realButton(),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/intermediate/absI.jpg'),
          fit: BoxFit.cover,
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'absCal': FieldValue.increment(126)});
