...
class HighCalories extends StatefulWidget {
  const HighCalories({Key key}) : super(key: key);

  @override
  _HighCaloriesState createState() => _HighCaloriesState();
}

class _HighCaloriesState extends State<HighCalories> {
  @override
