...
class IntermediateLegsStart extends StatefulWidget {
  const IntermediateLegsStart({Key key}) : super(key: key);

  @override
  _IntermediateLegsStartState createState() => _IntermediateLegsStartState();
}

class _IntermediateLegsStartState extends State<IntermediateLegsStart> {
        ...
        child: Stack(
          children: [
            ...
            if (second < 1) ...[
              ...
              erContainer('side hops', '20 sec'),
              realButton(),
            ] else if (51 <= second && second <= 75) ...[
              breakTime('squats'),
              realButton(),
            ] else if (76 <= second && second <= 100) ...[
              erContainer('squats', 'sets : X18'),
              realButton(),
            ] else if (101 <= second && second <= 125) ...[
              breakTime('SIDE-LYING LIFT-LEFT'),
              realButton(),
            ] else if (126 <= second && second <= 150) ...[
              erContainer('SIDE-LYING LIFT-LEFT', 'sets: X18'),
              realButton(),
            ] else if (151 <= second && second <= 175) ...[
              breakTime('SIDE-LYING LIFT-right'),
              realButton(),
            ] else if (176 <= second && second <= 200) ...[
              erContainer('SIDE-LYING LIFT-right', 'sets: X18'),
              realButton(),
            ] else if (201 <= second && second <= 225) ...[
              breakTime('backward lunge'),
              realButton(),
            ] else if (226 <= second && second <= 250) ...[
              erContainer('backward lunge', 'sets: X14(each)'),
              realButton(),
            ] else if (251 <= second && second <= 275) ...[
              breakTime('knee to chest'),
              realButton(),
            ] else if (276 <= second && second <= 300) ...[
              erContainer('knee to chest', '25 sec'),
              realButton(),
            ] else if (301 <= second && second <= 325) ...[
              breakTime('calf riase'),
              realButton(),
            ] else if (326 <= second && second <= 350) ...[
              erContainer('calf riase', '25 sec'),
              realButton(),
            ] else if (351 <= second && second <= 375) ...[
              breakTime('sumo squats'),
              realButton(),
            ] else if (376 <= second && second <= 400) ...[
              erContainer('sumo squats', 'set: X15'),
              realButton(),
            ] else if (401 <= second && second <= 425) ...[
              breakTime('CALF STRETCH-LEFT'),
              realButton(),
            ] else if (426 <= second && second <= 450) ...[
              erContainer('CALF STRETCH-LEFT', '25 sec'),
              realButton(),
            ] else if (451 <= second && second <= 475) ...[
              breakTime('CALF STRETCH-RIGHT'),
              realButton(),
            ] else if (476 <= second && second <= 500) ...[
              erContainer('CALF STRETCH-RIGHT', '25 sec'),
              realButton(),
            ] else
              endWorkout(),
          ],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/intermediate/legsI.jpg'),
          fit: BoxFit.cover,
      ...
      child: Stack(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              "Are you ready for today's Legs workout?",
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'legsCal': FieldValue.increment(131)});
