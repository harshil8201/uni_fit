...
class IntermediateArmsStart extends StatefulWidget {
  const IntermediateArmsStart({Key key}) : super(key: key);

  @override
  _IntermediateArmsStartState createState() => _IntermediateArmsStartState();
}

class _IntermediateArmsStartState extends State<IntermediateArmsStart> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/intermediate/armsI.jpg'),
          fit: BoxFit.cover,
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'armsCal': FieldValue.increment(118)});
