...
class AdvanceChestStart extends StatefulWidget {
  const AdvanceChestStart({Key key}) : super(key: key);

  @override
  _AdvanceChestStartState createState() => _AdvanceChestStartState();
}

class _AdvanceChestStartState extends State<AdvanceChestStart> {
        ...
        child: Stack(
          children: [
            ...
            if (second < 1) ...[
              ...
              erContainer('incline push ups', 'sets: X25'),
              realButton(),
              ...
              erContainer('chest stretch', '30 sec'),
              realButton(),
            ] else
              endWorkout(),
          ],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/advance/chestA.jpg'),
          fit: BoxFit.cover,
                      ...
                      child: InkWell(
                        onTap: () {
                          FirebaseFirestore.instance
                              .collection('UserData')
                              .doc(user.email)
                              .update({'chestCal': FieldValue.increment(147)});
